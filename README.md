...
|:------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------:|
|<img src="figures/parellelMotionForceContact_JointPositionPlot.PNG" width="400" height="500">   | <img src="figures/parellelMotionForceContact_ForcePlot.PNG" width="400" height="500">   |
